      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
             <form action="pages/admin/department/simpan-department.php"  method="POST">
              ...
              <table class="table table-hover" id="deptTable">
                ...
                <tbody>
                  <?php 
                      include 'config/database.php';
                      $no = 1;
                      $query = mysqli_query($kon,"SELECT * FROM department");
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="pages/admin/department/edit-department.php?id=<?php echo $row['DeptID'] ?>" class="btn btn-sm btn-primary"><i class="fa fa-regular fa-edit"></i></a>
                        <a href="pages/admin/department/hapus-department.php?id=<?php echo $row['DeptID'] ?>&name=<?php echo $row['DeptName'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-regular fa-trash"></i></a>
                      </td>
                  </tr>
