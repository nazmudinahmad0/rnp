      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
             <form action="simpan-user-category.php" method="POST">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-user-category.php?id=<?php echo $row['CID'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus-user-category.php?id=<?php echo $row['CID'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
