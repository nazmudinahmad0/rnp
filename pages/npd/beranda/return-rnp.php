...
<form action="pages/npd/beranda/return-rnp.php" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-sm-12">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" name="EmailSales" value="<?php echo $w;?>" class="form-control" readonly>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" value="<?php date_default_timezone_set('Asia/Jakarta'); echo date("Y-m-d");?>" class="form-control" readonly>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-4">
            <button type="submit" name="edit_kelas" id="Submit" class="btn btn-success">Return</button> 
        </div>
    </div>
</form>
