            ...
            <table class="table table-hover" id="tabel_kelas">
                ...
                <?php
                   ...
                   // include database
                    ...
                    $nilai=mysqli_query($kon,$query);
                    $row = mysqli_fetch_array($nilai);

                    $pl = $row['plant'];

                    $sql="select * from tdocument where plant = '$pl' order by NumDoc Desc";
                ...
                <tr>
                    ...
                    <td>
                    <button class="btn_edit btn btn-warning btn-circle" title="Update" NumDoc="<?php echo $data['NumDoc']; ?>" CodeProject="<?php echo $data['CodeProject']; ?>"><i class="fa fa-edit"></i></button>
                    <a href="index.php?page=history-rnp-npd&id=<?php echo $data['NumDoc'] ?>" class="btn btn-md btn-success" title="History Data RNP">History</a>
                    <!--<a href="#" class="btn btn-md btn-danger" title="History Data RNP">Return</a>-->
