...
<form action="pages/npd/beranda/edit-rnp.php" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-sm-2">
            ...
            <?php
            if ($aa == 'OPEN' AND $z == 'NPD' AND $c == 'Archineering Project - Estimasi BOM, Costing & Schedule' OR $c == 'Development/Improvement of Product - Estimasi BOM & Costing') {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                <input type="hidden" name="subjek" value="Send Sample" class="form-control">
        ...
        <div class="col-sm-4">
            <?php
                if ($aa == 'OPEN' AND $z == 'NPD' AND $c == 'New NPD - Sample Weaving Pattern' OR $c == 'Sample Varyan' OR $c == 'Sample Viroforms') {
                    echo '<button type="submit" name="edit_data" id="Submit" class="btn btn-warning">Send Sample</button>';
                }
                else {
                    echo '<button type="button" name="edit_data" id="Submit" class="btn btn-warning" disabled>Send Sample</button>';
                }
            ?>
        </div>
    </div>
