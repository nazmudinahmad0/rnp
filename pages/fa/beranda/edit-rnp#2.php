    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $d;?>" class="form-control" readonly>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input type="text" name="EmailMKT" value="" class="form-control" placeholder="Masukan Email Sales" required>
            </div>
        </div>
    </div>
    <div class="row">
