...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
              <table class="table table-bordered table-hover" id="tabel_so">
              <thead class="thead-light">
                ...
                ?>
                  ...
                  <tr>
                      ...
                      <td>
                      <a href="pages/admin_sales/beranda/insert-so.php?id=<?php echo $row['a'] ?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i></a></td>
