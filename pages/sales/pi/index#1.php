        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              FORM TRANSACTION PROFORMA INVOICE
            </div>
            <div class="card-body">
             <form action="pages/sales/pi/simpan-pi.php" method="POST">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="NumDoc" placeholder="Masukkan Document Number" required="required" value="<?php echo $kodeBarang ?>" class="form-control">
                </div>
                ...
                <div class="form-group">
                  <label>Date</label>
                  <input type="text" name="DatePI" placeholder="Input Date Proforma Invoice" class="form-control" id="id_0">
                </div>
              ...
              <table class="table table-hover" id="deptTable">
                ...
                <tbody>
                  <?php 
                      include('koneksi.php');
                      $no = 1;
                      $query = mysqli_query($connection,"SELECT t1.NumDoc as ND, t1.CatID as CAD, t1.NoPI as NP, t1.Customer as CUST, t1.DatePI as DP, t1.LeadTimeMKT as LT, t2.UserName as Usern FROM proforma_inv t1 left join user t2 on t1.UserID = t2.UserID");
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-pi.php?id=<?php echo $row['ND'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus-pi.php?id=<?php echo $row['ND'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
