          ...
          <div class="card">
            ...
            <div class="card-body">
             ...
             <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="update_date" value="<?php date_default_timezone_set('Asia/Jakarta'); echo date("m/d/Y H:i:s");?>" class="form-control" readonly>
                    </div>
                </div>
             </div>
             <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="email" name="EmailSales" value="itmanager@viroworld.com
                        
                        <?php
                        //include 'config/database.php';
                            
                        //$namauser = $_SESSION['username'];
                        //$query5 = mysqli_query($kon, "select * from sales where username = '$namauser'");
             ...
             <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Lokasi Plant NPD<font color="red">* </font>:</label>
             ...
             <div class="row">
                <div class="col-sm-7">
                    <div class="form-group">
                        <label>NPD Email<font color="red">* </font>:</label>
                        <input type="email" name="EmailRND" value="viroworld.an@gmail.com" class="form-control" required>
                        <!-- <select name="EmailRND" class="form-control">
                        <option value="npd.p1@viroworld.com">Ali.mashudi@viroworld.com; engineer.npdfiber@viroworld.com</option>
                        <option value="npd.p4@viroworld.com">Suseno.febriyanto@viroworld.com; Okky@polymindo.com; Sutriono@polymindo.com</option>
                        </select> -->
                        <input type="hidden" name="subjek" value="Reques BOM + Costing" class="form-control">
             ...
             <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="DateFeedbackExp" class="form-control" required>
                    </div>
                </div>
             </div>
             <div class="row">
             ...
             <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="WhatFiber" class="form-control" required>
                    </div>
                </div>
             </div>
             <div class="row">
             ...
             <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="DateTarget" class="form-control" required>
                    </div>
                </div>
             </div>
             <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="ImportantRequest" class="form-control">
                    </div>
                </div>
             </div>
