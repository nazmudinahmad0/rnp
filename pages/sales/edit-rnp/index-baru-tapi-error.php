<?php
    ...
    if(empty($attachment) AND empty($attachment1)){
        ...
        if ($send AND $_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($AppName)||isset($FrameName)||isset($GenifName)) {
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <input type="hidden" name="DateVerification" value="" class="form-control">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="hidden" name="EmailFA" value="<?php echo $y;?>" class="form-control" placeholder="Masukan Email FA" required>
            </div>
        </div>
    </div>
    <!-- <div class="row">
