        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                    <button class="btn_edit btn btn-success btn-circle" title="Edit Status Document" NumDoc="<?php echo $data['NumDoc']; ?>"><i class="fa fa-pen"></i></button>
                    <button class="btnn_edit btn btn-warning btn-circle" title="Edit Data RNP" NumDoc="<?php echo $data['NumDoc']; ?>" CodeProject="<?php echo $data['CodeProject']; ?>"><i class="fa fa-edit"></i></button>
                    <a href="index.php?page=edit-rnp&id=<?php echo $data['NumDoc'] ?>" class="btn btn-md btn-warning"><i class="fa fa-regular fa-edit"></i></a>
                </td>
                </tr>
                <?php endwhile; ?>
                </tbody>
...
<script>
    ...
    $('.btnn_edit').on('click',function(){

        var NumDoc = $(this).attr("NumDoc");
        var CodeProject = $(this).attr("CodeProject");
        $.ajax({
            url: 'pages/sales/beranda/edit-rnp.php',
            method: 'post',
